...
CREATE TABLE `doctor_detail` (
  ...
  `DOCTOR_ID` INT(10) UNSIGNED NOT NULL,
  `AREA_OF_PRACTICE_NAME` VARCHAR(255)  NULL,
  `AREA_OF_PRACTICE_DETAILS` VARCHAR(1000)  NULL,
  `SPECIAL_HONORS_1` VARCHAR(255)  NULL,
  `SPECIAL_HONORS_2` VARCHAR(255)  NULL,
  `SPECIAL_HONORS_3` VARCHAR(255)  NULL,
  `PRACTICE_NAME` VARCHAR(255)  NULL,
  `PRACTICE_ADDRESS` VARCHAR(255)  NULL,
  `PRACTICE_CITY` VARCHAR(255)  NULL,
  `PRACTICE_STATE` VARCHAR(255)  NULL,
  `PRACTICE_ZIP` VARCHAR(255)  NULL,
  `PRACTICE_HOURS1` VARCHAR(255)  NULL,
  `PRACTICE_HOURS2` VARCHAR(255)  NULL,
  `WEBSITE` VARCHAR(255)  NULL,
  `RESIDENCIES1` VARCHAR(255)  NULL,
  `RESIDENCIES2` VARCHAR(255)  NULL,
  `RESIDENCIES3` VARCHAR(255)  NULL,
  `MEDICAL_SCHOOL1` VARCHAR(255)  NULL,
  `MEDICAL_SCHOOL2` VARCHAR(255)  NULL,
  `MEDICAL_SCHOOL3` VARCHAR(255)  NULL,
  `AFFILIATIONS1` VARCHAR(255)  NULL,
  `AFFILIATIONS2` VARCHAR(255)  NULL,
  `AFFILIATIONS3` VARCHAR(255) NULL,
  PRIMARY KEY (`DOCTOR_DETAILS_ID`),
  KEY `FK_doctor_details` (`DOCTOR_ID`),
  CONSTRAINT `FK_doctor_detail` FOREIGN KEY (`DOCTOR_ID`) REFERENCES `doctor` (`DOCTOR_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO doctor_detail (DOCTOR_ID, AREA_OF_PRACTICE_NAME, AREA_OF_PRACTICE_DETAILS, SPECIAL_HONORS_1, SPECIAL_HONORS_2, SPECIAL_HONORS_3, PRACTICE_NAME, PRACTICE_ADDRESS, PRACTICE_CITY, 
