	...
	<div id = "body" >
 		<div class="mainContent">
			...
			<section class ="topcontent" >
				  ...
				  <form name="upadteForm" action="updatepatientbasicinfo.do" method="post">
                  <table class = "usertable">
                  	<tr class = "basicdetails">
                  		<td> Full Name </td>
                  		<td ><input type="text" class="patienti-input" name="fullname" value="${patient.name}" /></td>
                    </tr> 		
                    <tr class = "basicdetails">
                  		<td> Date of Birth </td>
                  		<td ><input type="text" class="patienti-input" name="dateofbirth" value="<fmt:formatDate pattern="MM/dd/yyyy" 
            value="${patient.dateOfBirth}" />" /></td>
                    </tr> 
                    <tr class = "basicdetails" >
                  		<td> Gender </td>
                  		<td ><input type="text" class="patienti-input" name="gender" value="${patient.gender}" /></td>
                    </tr> 
                    <tr class = "basicdetails">
                  		<td> Location </td>
                  		<td ><input type="text" class="patienti-input" name="location" value="${patient.location}" /></td>
                    </tr> 
                  
                  </table> 
  				  <a href="javascript:" onclick="document.upadteForm.submit()">
  				  	<img id="addimage" src="images/add.png" />
 				  </a>
				</form>
			</article>  				
