	...
	<div id = "body" >
 		<div class="mainContent">
			...
			<section class ="topcontent" >
				  ...
				  <header><h2>Add the medication details </h2></header>
				  <form action="addpatientmedication.do" method="post">
				  <h3> Medication</h3>
  			  	  <input class = "category"  type="text" name="medication"  autofocus required><br>
  			  	  <h3>Notes</h3>
  			      <input class ="notes"  type="text" name="notes"  autofocus required><br>
  			      <p>  </p>
 			      <input type="submit" name="Add medication" value="Add Medication">
			</form>
				  </article>  
