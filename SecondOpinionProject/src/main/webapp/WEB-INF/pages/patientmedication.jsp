	...
	<div id = "body" >
 		<div class="mainContent">
			...
			<section class ="topcontent" >
				  ...
				  <p> <em> Complete your medication details </em> </p>
 				...
 				<article class= "bottomcontent">
				  <table class = "usertable" >
				  	<c:if test="${not empty patientMedications}">
     					<c:forEach var="medication" items="${patientMedications}">
				   			<tr>
				   				<td class = "borderbottom" style="width:40%;">${medication.medicationName}</td>
				   				<td class = "borderbottom" style="width:50%;">${medication.notes}</td>
				   				<td class = "borderbottom" style="width:10%;">
				   					<form name="deleteForm_${medication.patientMedicationId}" action="removepatientmedication.do" method="post">
				   						<input type="hidden" name="medicationId" value="${medication.patientMedicationId}" />
				   						<a href="javascript:" onclick="document.deleteForm_${medication.patientMedicationId}.submit()">
