		    ...
		    <article class= "bottomcontent">
				  ...
				  <tr>
				   <td class = "userdetails" >
				  	 <a  href="patientbasicinfo.do"> Basic Information</a> </td></tr>
				  	<tr>
				     <td class = "userdetails">
				     <a  href="patientmedication.do"> Medications</a> </td></tr>
				  <tr>
				   <td class = "userdetails">
				    <a  href="patientsymptoms.do"> Symptoms and Conditions </a> </td></tr>
				  <tr>
				   <td class = "userdetails">
				    <a href="patientallergies.do"> Allergies</a></td></tr>
				  <tr>
				   <td class = "userdetails" >
